...
<body>
    ...
    if (empty($_SESSION['shopCart'])){
        ...
        echo '<thread><tr><th>Year</th><th>Category</th><th>Item</th><th>Total</th><th>Option</th></tr></thread>';
        echo '<tbody>';
        $table = array();
        ...
        for($x = 0; $x < count($table); $x++){
            ...
            // Remove Item button
            echo '<input type="submit" class="btn btn-primary" name="submit" value="Remove Item">';
            echo '</form></td>';
            echo '</tr>';
